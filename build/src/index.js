                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, request_1.default("https://github.com/HookAder/react-admin-template/archive/master.zip").pipe(fs_1.default.createWriteStream("React后台管理模板.zip"))];
                        case 4:
                            _a.sent();
                            console.log("文件下载成功");
                            _a.label = 5;
